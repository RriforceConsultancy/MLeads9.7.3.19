...
public class CameraProvider {
    ...
    public Camera getCamera(int cameraId) {
        ...
        } catch (Exception e) { System.out.println("Error getCamera 312 : " + e);}
    ...
    public void setOrientation(Display display, Camera camera, int cameraId) {
        ...
        try {
            ...
            System.out.println("Error in Camera Orientation : " + e);
        }
    ...
    public boolean startPreview(SurfaceHolder holder, Camera camera) {
        ...
        try {
            ...
            camera.startPreview();
            started = true;
        } catch (IOException e) { System.out.println("Error startPreview 1235 : " + e); }
    ...
    public void stopPreview(Camera camera) {
        try {
            camera.stopPreview();
        } catch (Exception e){System.out.println("Error stopPreview 1235 : " + e); }
    }
